...
import com.fiap.Hackaton.infraestructure.cliente.dto.FecharReservaDto;
...
public class FechamentoReservaUseCase {
    ...
    private FecharReservaDto prepareReservaDetails(Long idReserva) {
        ...
        details.setServicosConsumidos(reserva.getServicosConsumidos().stream().map(servico -> servico.getServico())
