...
public class ClienteRequestDataTest {
    ...
    public void testClienteRequestData() {
        ...
        ClienteRequestData clienteRequestData = new ClienteRequestData(paisOrigem, cpf, passaporte, nome, dataNascimento, enderecoPaisOrigem, telefone, email);

        // Act
        Set<ConstraintViolation<ClienteRequestData>> violations = validator.validate(clienteRequestData);
